'''
Purpose: To define auxiliary model components related to sequences/molecular graphs, including modules such as CNN, GCN, BAN/FC, etc.
Input: Sequence features, molecular graph node/edge features, or protein structure-related features.
Output: Neural network representations of proteins or molecular graphs.
'''
