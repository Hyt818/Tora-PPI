'''
Purpose: Read PPI action files and protein sequence/vector files, and construct PPI graph data and split index for Tora-PPI training.
Input: protein.actions file, protein sequence dictionary, amino acid vector file, split JSON.
Output: GNN_DATA object, which contains protein index, PPI edges, label matrix, PyG Data graph, and train/test indices. 
'''
...
from model.utils.utils import UnionFindSet, get_bfs_sub_graph, get_dfs_sub_graph
