'''
Purpose: Preprocess molecular or structure-related inputs into graph data, including atomic features, edges, PPR/heat kernel and other graph-enhancing information.
Input: Molecular structure data, SMILES/molecular objects, sequence or structure-related raw files.
Output: Graph data that can be loaded by PyG, node features, edge indices and edge weights. 
'''
